...
function split_and_matrix(matrix) {
    let rowSplit = iris.split("\n");
    for (let element of rowSplit) {
        let elementSplit = element.split(',');
        matrix.push(elementSplit);
    }
}
...
const iristable = [
    ["iris", "Sepal L", "Sepal W", "Petal L", "Petal W", "Count"],
    ["Setosa", setosa_sepal_Length, setosa_sepal_Width, setosa_petal_Length, setosa_petal_Width, setosa_count],
    ["Versicolor", versicolor_sepal_Length, versicolor_sepal_Width, versicolor_petal_Length, versicolor_sepal_Width, versicolor_count],
